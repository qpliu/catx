class Settings{
	...
	this.settings = [
		...
		"Make this more negative to increase microphone sensitivity.  You have to yell really loud, try making it more negative.  Like -70."],
		...
		"We try to cancel overtones by checking harmonics and subharmonics.  This is number of harmonics we check.  Try changing it to 1 or 2 if you have trouble getting yellow snake to appear."],
	    ["Subharmonics","subharmonics","3",Number,
		"We try to cancel overtones by checking harmonics and subharmonics.  This is number of subharmonics we check.  Try changing it to 1 or 2 if you have trouble getting yellow snake to appear."],
